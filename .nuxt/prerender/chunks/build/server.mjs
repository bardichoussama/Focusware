...
import { getContext, executeAsync } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/HP/Desktop/Focusware/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-Czh-utm9.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-PodNM7H2.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-BhVs9KlJ.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./products-enDzEgTp.mjs')
  },
  {
    name: "resources",
    path: "/resources",
    component: () => import('./resources-YcbC1-Dn.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-9mwg-g6V.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-2M1Axs_9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CL0d_PEu.mjs'));
