...
import { createHooks } from "C:/Users/HP/Desktop/Focusware/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/HP/Desktop/Focusware/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/HP/Desktop/Focusware/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "C:/Users/HP/Desktop/Focusware/node_modules/radix3/dist/index.mjs";
import { defu } from "C:/Users/HP/Desktop/Focusware/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/Users/HP/Desktop/Focusware/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-Czh-utm9.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-PodNM7H2.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-BhVs9KlJ.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-enDzEgTp.js")
  },
  {
    name: "resources",
    path: "/resources",
    component: () => import("./_nuxt/resources-YcbC1-Dn.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-9mwg-g6V.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-2M1Axs_9.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CL0d_PEu.js"));
